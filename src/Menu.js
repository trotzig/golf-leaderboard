...
export default function Menu({ activeHref }) {
  return (
    <nav>
      ...
      <Link href="/leaderboard" className="menu-item-can-be-made-active">Leaderboard</Link>
      <Link href="/players" className="menu-item-can-be-made-active">Players</Link>
      <Link href="/schedule" className="menu-item-can-be-made-active menu-hide-mobile">
        Schedule
      </Link>
